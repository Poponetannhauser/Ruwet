export default function BoardLoading() {
  return (
    <div className="flex flex-col flex-1 min-h-screen bg-zinc-950 text-zinc-100 font-sans">
      ...
      <main className="flex-1 p-4 sm:p-8 overflow-x-auto">
        <div className="flex gap-6 items-start">
          {[1, 2, 3, 4].map((col) => (
            <div
              key={col}
              className="w-80 flex-shrink-0 rounded-xl bg-zinc-900 border border-zinc-800 p-4 space-y-4 animate-pulse"
            >
              ...
              <div className="space-y-3">
                <div className="h-24 rounded-xl bg-zinc-950 border border-zinc-800 p-3.5 space-y-2">
                  <div className="h-4 w-3/4 rounded bg-zinc-800" />
                  <div className="h-3 w-1/2 rounded bg-zinc-800/60" />
                </div>
                <div className="h-28 rounded-xl bg-zinc-950 border border-zinc-800 p-3.5 space-y-2">
