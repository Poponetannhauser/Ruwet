  ...
  return (
    <div className="flex flex-col flex-1 min-h-screen bg-zinc-950 text-zinc-100 font-sans">
      ...
      <main className="flex flex-1 w-full max-w-7xl flex-col p-6 sm:p-10 mx-auto space-y-8">
        <div className="bg-zinc-900 border border-zinc-800 p-6 sm:p-8 rounded-2xl flex items-center justify-between">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5">
          {[1, 2, 3].map((i) => (
            <div
              key={i}
              className="h-36 rounded-2xl bg-zinc-900 border border-zinc-800 p-6 animate-pulse flex flex-col justify-between"
            >
